...
- You MAY use tools like search, read, or web fetch to gather information.
- If you decide to use tools like search, read, or web fetch, then you SHOULD use a subagent who will do the work for you and return you the relevant information but in a compacted manner
